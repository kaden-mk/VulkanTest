...
namespace VkRenderer {
	...
	void PointLightSystem::createPipeline(VkRenderPass renderPass)
	{
		...
		pipeline = std::make_unique<VulkanPipeline>(device, "VkRenderer/shaders/compiled/point_light_vert.spv", "VkRenderer/shaders/compiled/point_light_frag.spv", pipelineConfig);
	}
